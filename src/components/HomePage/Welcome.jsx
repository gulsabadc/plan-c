...
const Welcome = () => {
  const imageText1 = "Welcome to  ";
  const imageText2 = "Plan C, LLC.";
  const title = "Life rarely goes according to the first plan";

  const description =
    " —or even the second. Whether in business, technology, or innovation, challenges arise, forcing us to adapt and rethink our approach.<br/> <br/> At Plan C, we embrace out-of-the-box thinking—not as a last resort, but as a strategic advantage. When Plan A falls short and Plan B doesn't quite fit, we take what we've learned, refine our vision, and craft a smarter, more insightful path forward—a Plan C.";
