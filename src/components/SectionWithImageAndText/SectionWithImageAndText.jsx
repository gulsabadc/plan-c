...
const SectionWithImageAndText = ({
  ...
  return (
    <section
      className={`w-full  py-[30px] sm:py-[6.25rem] px-[30px] sm:px-[10rem] relative sm:mt-0 mt-0  m-0`}
      style={sectionStyle}
    >
      <div
      ...
      >
        <div className="w-full md:w-1/2 flex flex-col items-center text-center md:items-start md:text-left">
          ...
          />
          <p
            className="text-[24px] sm:text-[60px] text-white font-bold leading-[24px] sm:leading-[60px] mb-2"
            style={{
              letterSpacing: "-3%",
            }}
          ...
          ></p>
          <p
            className="text-[24px] sm:text-[60px]  font-bold leading-[24px] sm:leading-[60px] mb-2"
            style={{
              letterSpacing: "-3%",
            }}
          >
